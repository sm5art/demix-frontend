...
import { FILES, FILES_SUCCESS, FILES_ERROR, ME, ME_SUCCESS, ME_ERROR, COUNT, COUNT_ERROR, COUNT_SUCCESS } from './actions';

// the initial state of this reducer
const INITIAL_STATE = { files: { loading: false, error: null, data: null, uploadedFileCount: null }, me: { loading: false, error: null, data: null,}, count: { loading: false, error: null, data: null,} }
...
function reducer(state = INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case COUNT:
      return {
        ...state, count: { loading: true, error: null, data: null,},
      }
    case COUNT_SUCCESS:
      return {
